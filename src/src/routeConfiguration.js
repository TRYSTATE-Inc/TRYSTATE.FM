...
const AboutPage = loadable(() =>
    import ( /* webpackChunkName: "AboutPage" */ './containers/NotFoundPage/NotFoundPage'));
...
const LandingPage = loadable(() =>
    import ( /* webpackChunkName: "LandingPage" */ './containers/SearchPage/SearchPage'));
...
const PrivacyPolicyPage = loadable(() =>
    import ( /* webpackChunkName: "PrivacyPolicyPage" */ './containers/NotFoundPage/NotFoundPage'));
...
const SearchPage = loadable(() =>
    import ( /* webpackChunkName: "SearchPage" */ /* webpackPrefetch: true */ './containers/SearchPage/SearchPage'));
...
const TermsOfServicePage = loadable(() =>
    import ( /* webpackChunkName: "TermsOfServicePage" */ './containers/NotFoundPage/NotFoundPage'));
...
const StyleguidePage = loadable(() =>
    import ( /* webpackChunkName: "StyleguidePage" */ './containers/NotFoundPage/NotFoundPage'));
...
const routeConfiguration = () => {
    return [{
        ...
        },
        {
            ...
            auth: true,
            component: () => ( <
                NamedRedirect name = "EditListingPage"
                params = {
        ...
        },
        {
            ...
            auth: true,
            authPage: 'LoginPage',
            component: () => < NamedRedirect name = "InboxPage"
            params = {
                { tab: 'sales' }
            }
            />,
