...
const IconLogo = props => {
    ...
    return ( 
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 966.98 88.61" className = {Classes}>
       
        <g id="Layer_2" data-name="Layer 2">
            <g id="Layer_1-2" data-name="Layer 1">
                <text className={Classes} transform="translate(0 69.06) scale(1.34 1)">
                T R Y S T A T E . F M
                </text>
            </g>
        </g>
